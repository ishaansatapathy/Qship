...
export default function ActionApprovePage() {
  ...
  const act = useCallback(
    async (action: "approve" | "deny") => {
      ...
      try {
        ...
        toast.success(action === "approve" ? "Approved and executed" : "Request denied");
  ...
  return (
    <div className="mx-auto max-w-lg space-y-6 p-8">
      <div>
        <h1 className="text-xl font-semibold">Action approval</h1>
        <p className="text-muted-foreground mt-1 text-sm">
          Review the requested action before it runs in your workspace.
        </p>
      </div>
