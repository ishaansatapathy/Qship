  ...
  if (prep.error) {
    return (
      <div className="mpp-root">
        ...
        <p className="mpp-text" style={{ color: "var(--qship-dim)", fontSize: 12 }}>
          Couldn&apos;t load prep.{" "}
          <button type="button" style={{ color: "var(--qship-accent)", background: "none", border: "none", cursor: "pointer", fontSize: 12 }} onClick={() => prep.refetch()}>
            Retry
          </button>
        </p>
      </div>
  ...
  return (
    <div className="mpp-root">
      ...
      <div className="mpp-prep-note">
        <CheckCircle2 size={13} style={{ flexShrink: 0, marginTop: 1, color: "var(--qship-accent)" }} />
        <p>{d.prepNote}</p>
      </div>
