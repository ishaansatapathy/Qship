  ...
  if (ctx.error) {
    return (
      <div className="scp-root">
        ...
        <p className="scp-text" style={{ color: "var(--qship-dim)", fontSize: 12 }}>
          Couldn&apos;t load context.{" "}
          <button type="button" style={{ color: "var(--qship-accent)", background: "none", border: "none", cursor: "pointer", fontSize: 12 }} onClick={() => ctx.refetch()}>
            Retry
          </button>
        </p>
      </div>
  ...
  return (
    <div className="scp-root">
      ...
      <div className="scp-block scp-action-block">
        <ArrowRight size={13} style={{ flexShrink: 0, marginTop: 1, color: "var(--qship-accent)" }} />
        <div>
