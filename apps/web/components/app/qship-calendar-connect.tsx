...
export function QshipCalendarConnect() {
  ...
  if (isLoading) {
    return (
      <span className="qship-gmail-connect qship-gmail-connect--loading" aria-label="Checking Calendar">
  ...
  if (!isConnected) {
    return (
      <a href={connectHref} className="qship-btn-ghost" style={{ fontSize: 13, padding: "8px 14px" }}>
        <Calendar size={14} />
        Connect Calendar
      </a>
    );
      ...
      {open ? (
        <div className="qship-gmail-connect-menu" role="menu">
          <div className="qship-gmail-connect-menu-head">
            <span className="qship-gmail-connect-menu-title">Primary calendar</span>
            <span className="qship-gmail-connect-menu-badge">Active</span>
          </div>
          <p className="qship-gmail-connect-menu-copy">
            Events sync with Google Calendar. Invites send directly from your account.
          </p>
